  ...
  _buildMenuItem(Food menuItem) {
    return Center(
      ...
      Positioned(
        ...
        child: Column(
          children: <Widget>[
            Text(menuItem.name, style: TextStyle(color: Colors.white, fontSize: 20.0)),
            Text('\$${menuItem.price}',
            ...
            child: Column(
              ...
              children: <Widget>[
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                  ...
                  Text("0.3 miles away", style: TextStyle(fontSize: 18.0))
                ]),
                ...
                SizedBox(height: 10.0),
                Center(child: Text("Menu", style: TextStyle(fontSize: 22.0, fontWeight: FontWeight.bold))),
                SizedBox(height: 10.0),
                Expanded(
