    ...
    restaurants.forEach((Restaurant restaurant) {
      restaurantList.add(Container(
          ...
          child: Row(children: <Widget>[
            ClipRRect(
                borderRadius: BorderRadius.circular(15.0),
                child: Image(height: 150.0, width: 150.0, image: AssetImage(restaurant.imageUrl), fit: BoxFit.cover)),
            Expanded(
              child: Container(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text("Nearby Restaurants",
                      style: TextStyle(fontSize: 24.0, fontWeight: FontWeight.w600, letterSpacing: 1.2)),
                ),
                _buildRestaurants()
              ],
            )
